...
class EmailModel():
    def __init__(self) -> None:
        ...
        self.headers = {
            ...
            'Authorization': 'Bearer sk-4ce428b32cc74ee39029bb69fc3144f4' # Replace with your own api key here
        }
    ...
    def process_input(self, input_dict):
        payload = '''
                    ...
                    I would like to write an email to reach out to Professor {Professor_Name} asking for {Opptunity_Type} opportunities starting in the {Semester}, and {Alternate_Opportunity_Type} opportunities starting as soon as possible.
                    ...
                    '''.format(
                        ...
                        Opptunity_Type=input_dict['Opptunity_Type'],
